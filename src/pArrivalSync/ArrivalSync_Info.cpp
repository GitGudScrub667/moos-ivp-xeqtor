...
void showExampleConfigAndExit()
{
  ...
  blk("                                                                ");
  blk("  // Orbit phase-lock (opt-in; off unless enable_orbit_lock)    ");
  blk("  enable_orbit_lock = true                                      ");
  blk("  circle_x    = 45          // ring center                      ");
  blk("  circle_y    = -95                                             ");
  blk("  circle_rad  = 36.07                                           ");
  blk("  orbit_speed = 2.0         // nominal ring speed (= omega*r)    ");
  blk("  orbit_gain  = 0.03        // m/s speed correction per deg err  ");
  blk("  orbit_min   = 1.0         // clamp on modulated orbit speed    ");
  blk("  orbit_max   = 3.0                                             ");
  blk("  orbit_var   = ENCIRCLE_UPDATE                                 ");
  blk("                                                                ");
  blk("  vehicle = abe, 81.07, -95     // name, slot_x, slot_y         ");
