...
# Slot (cardinal) points on the common ring (center 45,-95 r 27.05).
echo "72.05,-95"   >  vslotpos.txt   # abe -> E
echo "45,-67.95"   >> vslotpos.txt   # ben -> N
echo "17.95,-95"   >> vslotpos.txt   # cal -> W
echo "45,-122.05"  >> vslotpos.txt   # deb -> S
