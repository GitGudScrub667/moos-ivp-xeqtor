#!/bin/bash
#------------------------------------------------------------
#  Script: launch.sh   (pireas_2boat - 2-boat encircle, Pireas)
#  Launches a shoreside + 2 sim boats (asha/E, bama/W). On DEPLOY each
#  boat transits to its E/W slot (arriving together) then orbits the
#  common ring, 180 deg apart.  Usage: ./launch.sh [warp]
#------------------------------------------------------------
...
#------------------------------------------------------------
#  Part 1: (Re)generate the fixed 2-boat field.
#------------------------------------------------------------
./init_field.sh
