#!/bin/bash
#------------------------------------------------------------
#  Script: init_field.sh   (pireas_N_boat)
#  Emits the FIXED 5-boat POOL for the Pireas encircle mission.
...
# independent of how many boats deployed). Clustered E of the formation around
# (-68,-41), clear of the permanent MIO station + its no-go at (-90.43,-52.25)
# and the eastern buoys; all headed W toward the ring. (First 4 are the proven
# pireas_v2 cluster; ewan added at the cluster centre.)
